'''
    ...
    抽象数据类型（ADT）
        ...
        addFront(item)       在队首插入一个原色，参数为待插入元素，无返回值
        addRear()            在队尾插入一个元素，参数为待插入元素，无返回值
        removeFront()        在队首移出一个元素，无参数，返回该移除的元素，双端队列会被改变
        removeRear()         在队尾移出一个元素，无参数，返回该移除的元素，双端队列会被改变
...
print(judeString("年少的欢喜是你你是喜欢的少年"))
print(judeString("asdfgh"))
